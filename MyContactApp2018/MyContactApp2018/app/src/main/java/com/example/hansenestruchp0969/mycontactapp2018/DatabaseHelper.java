...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public boolean insertData(String name1, String name2, String name3){
        ...
        contentValue.put(COLUMN_NAME_CONTACT, name1);
        contentValue.put(COLUMN_PHONE_CONTACT, name2);
        contentValue.put(COLUMN_ADDRESS_CONTACT, name3);
